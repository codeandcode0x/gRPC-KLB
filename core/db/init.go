...
func redisInit() {
	...
	Cache = redis.NewClient(&redis.Options{
		...
		Dialer: func() (net.Conn, error) {
			...
			return netDialer.Dial("tcp", cacheHost+":"+cachePort)
		},
	...
	log.Printf("redis pool info: Hits=%d Misses=%d Timeouts=%d TotalConns=%d IdleConns=%d StaleConns=%d\n",
		Cache.PoolStats().Hits,
		Cache.PoolStats().Misses,
		Cache.PoolStats().Timeouts,
		Cache.PoolStats().TotalConns,
		Cache.PoolStats().IdleConns,
		Cache.PoolStats().StaleConns)
